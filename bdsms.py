...
opt()
while tt<2:
	opt2=str(input(blue+"\n\n [>] Enter the number of option : "+blue))
	if opt2=="1":
		text=cyan+"\t\tNahid Alam"+green+"\n\n\t\t★★ Nahid Alam BD SMS Bomber ★★   \n" 
		os.system('clear')
		header()
		number=str(input(blue+"\n\n [>] Enter The BD Number : "+red))
		ammount=int(input(blue+"\n [>] Enter The Ammount : "+red))
		os.system('clear')
		notice=cyan+"\n\t   [•] Nahid Alam Tools in progress......\n\n"
		header()
		ammount2=1
		totalsent=0
		totalnotsent=0
		while ammount2<ammount+1:
			try:
				...
				if ammount2==1:
					print(cyan+"\n\t  ★★FIRE★★==>   "+green+"[✓] 1st SMS Sent.")
				elif ammount2==1:
					print(cyan+"\n\t  ★★FIRE★★==>   "+green+"[✓] 2nd SMS Sent.")
				elif ammount2==1:
					print(cyan+"\n\t  ★★FIRE★★==>   "+green+"[✓] 3rd SMS Sent.")
				else:
					print(cyan+"\n\t  ★★FIRE★★==>   "+green+"[✓] "+str(ammount2)+"th SMS Sent.")
				time.sleep(1)
				totalsent+=1
				ammount2+=1
			except:
				if ammount2==1:
					print(cyan+"\n\t  ★★FIRE★★==>   "+red+"[×] 1st SMS Not Sent.")
				elif ammount2==2:
					print(cyan+"\n\t  ★★FIRE★★==>   "+red+"[×] 2nd SMS Not Sent.")
				elif ammount2==3:
					print(cyan+"\n\t  ★★FIRE★★==>   "+red+"[×] 3rd SMS Not Sent.")
				else:
					print(cyan+"\n\t  ★★FIRE★★==>   "+red+"[×] "+str(ammount2)+"th SMS Not Sent.")
					time.sleep(10)
					ammount2+=1

If there is no error in life, there is no solution="error404"
#IMPORT
...
if upchck==version:
	...
	try:
		...
		print(green)
		os.system("cd $HOME && git clone https://github.com/DareDevil360/4331")
		clear()
		...
		for i in range(99999999999):
			os.system("clear")
			a=input(cyan+"\n"*10+" [>] Please Exit Termux from Notification Bar. Then Again Open Tool Tools By :\n\n "+yellow+"\t [1] Exit Termux\n\t [2] Open Termux"+"\n\t [3] cd $HOME/roc-x"+yellow+"\n\t [4] "+yellow+"python3 main.py\n\n")
